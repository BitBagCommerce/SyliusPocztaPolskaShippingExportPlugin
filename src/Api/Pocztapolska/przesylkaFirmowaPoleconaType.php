...
class przesylkaFirmowaPoleconaType extends przesylkaRejestrowanaType
{
     ...
     */
    public function __construct($guid, $pakietGuid, $opakowanieGuid, $opis, $adres, $numerNadania, $sygnatura, $terminSprawy, $rodzaj, $zasadySpecjalne, $posteRestante, $iloscPotwierdzenOdbioru, $masa, $miejscowa, $obszarMiasto, $kategoria, $gabaryt)
    {
